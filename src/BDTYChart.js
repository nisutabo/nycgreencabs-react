...
import { totalsPerDayToYellow } from './store/totalsPerDayToYellow';
import { totalsPerHourToYellow } from './store/totalsPerHourToYellow';
...
export default class BDTYChart extends Component {
  ...
  render(){
    ...
    const ridesDaily = () => {
      let result = [];
      for (let day in totalsPerDayToYellow) {
        result.push(totalsPerDayToYellow[day][0])
      }
      return result
    }
    ...
    const faresDaily = () => {
      let result = [];
      for (let day in totalsPerDayToYellow) {
        result.push(totalsPerDayToYellow[day][1])
      }
      return result
    }
    ...
    const milesDaily = () => {
      let result = [];
      for (let day in totalsPerDayToYellow) {
        result.push(totalsPerDayToYellow[day][2])
      }
      return result
    }
    ...
    const ridesHourly = () => {
      let result = [];
      for (let hour in totalsPerHourToYellow) {
        result.push(totalsPerHourToYellow[hour][0])
      }
      return result
    }
    ...
    const faresHourly = () => {
      let result = [];
      for (let hour in totalsPerHourToYellow) {
        result.push(totalsPerHourToYellow[hour][1])
      }
      return result
    }
    ...
    const milesHourly = () => {
      let result = [];
      for (let hour in totalsPerHourToYellow) {
        result.push(totalsPerHourToYellow[hour][2])
      }
      return result
    }
    ...
    const chartValues = {
      ...
      const hourlyValues = {
        labels: Object.keys(totalsPerHourToYellow),
        datasets: [
          {
            type: 'line',
            label: 'TOTAL RIDES (to yellow zones only)',
