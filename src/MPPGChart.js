...
export default class MPPGChart extends Component {
  ...
  bubbleDataSets = () => {
    let datasets = []
    for (let location in bubbleChartDataOutbound){
      datasets.push(
        {
          label: [location],
          ...
          data: [{
            x: Math.round(bubbleChartDataOutbound[location].totalmiles),
            y: Math.round(bubbleChartDataOutbound[location].totalfares),
            r: bubbleChartDataOutbound[location].totalrides/10000
          }],
          faresPerMile: bubbleChartDataOutbound[location]['fares per mile'],
          faresPerRide: bubbleChartDataOutbound[location]['fares per ride'],
          tmRanking: bubbleChartDataOutbound[location]['total miles ranking'],
          tfRanking: bubbleChartDataOutbound[location]['total fares ranking'],
          trRanking: bubbleChartDataOutbound[location]['total rides ranking'],
          fpmRanking: bubbleChartDataOutbound[location]['fares per mile ranking'],
          fprRanking: bubbleChartDataOutbound[location]['fares per ride ranking']
        }
      )
    }
    return datasets
    ...
    if (this.state.showTable === 'RIDES') {
      return (
        <Table basic='very' compact>
          <Table.Body>
            <Table.Row className='side-table-row'><Table.Cell>LOCATION</Table.Cell><Table.Cell>TOTAL RIDES FROM, TO GREEN</Table.Cell><Table.Cell>TOTAL FARES COLLECTED</Table.Cell></Table.Row>

            <Table.Row className='side-table-column'><Table.Cell>ASTORIA</Table.Cell><Table.Cell>296,694 - 1st</Table.Cell><Table.Cell>$3,288,673 - 4th</Table.Cell></Table.Row>

            <Table.Row className='side-table-column'><Table.Cell>CENTRAL HARLEM</Table.Cell><Table.Cell>268,295 - 2nd</Table.Cell><Table.Cell>$3,500,308 - 2nd</Table.Cell></Table.Row>

            <Table.Row className='side-table-column'><Table.Cell>ELMHURST</Table.Cell><Table.Cell>260,252 - 3rd</Table.Cell><Table.Cell>$$2,889,019 - 7th</Table.Cell></Table.Row>

            <Table.Row className='side-table-column'><Table.Cell>EAST HARLEM NORTH</Table.Cell><Table.Cell>247,201 - 4th</Table.Cell><Table.Cell>$3,916,109 - 1st</Table.Cell></Table.Row>

            <Table.Row className='side-table-column'><Table.Cell>WILLIAMSBURG (NORTH SIDE)</Table.Cell><Table.Cell>206,746 - 5th</Table.Cell><Table.Cell>$$3,198,871 - 5th</Table.Cell></Table.Row>

            <Table.Row className='side-table-column'><Table.Cell>PARK SLOPE</Table.Cell><Table.Cell>203,862 - 6th</Table.Cell><Table.Cell>$$2,594,047  - 8th</Table.Cell></Table.Row>

            <Table.Row className='side-table-column'><Table.Cell>CENTRAL HARLEM NORTH</Table.Cell><Table.Cell>193,035 - 7th</Table.Cell><Table.Cell>$$2,270,520 - 10th</Table.Cell></Table.Row>

            <Table.Row className='side-table-column'><Table.Cell>FORT GREENE</Table.Cell><Table.Cell>183,415 - 8th</Table.Cell><Table.Cell>$$2,405,471 - 9th</Table.Cell></Table.Row>

            <Table.Row className='side-table-column'><Table.Cell>EAST HARLEM SOUTH</Table.Cell><Table.Cell>180,828 - 9th</Table.Cell><Table.Cell>$$3,476,182  - 3rd</Table.Cell></Table.Row>

            <Table.Row className='side-table-column'><Table.Cell>JACKSON HEIGHTS</Table.Cell><Table.Cell>169,017 - 10th</Table.Cell><Table.Cell>$1,868,629 - 15th</Table.Cell></Table.Row>
              ...
              <div className='row'>
                <div className='column column-12 highlight-header'>
                  ...
                  <div className='highlight-subheader'>
                    Total Rides To Green Zone - {this.state.totalRides.toLocaleString()}<br></br>Ranking - {this.state.trRanking}
                  </div>
                </div>
              </div>
              <div className='row'>
            ...
            <div className='side-table-title'>
              ...
              <Dropdown
                ...
                options=
                  {
                    [
                      {text: 'TOTAL RIDES TO GREEN ZONE', value: 'RIDES'},
