                  ...
                  {this.state.locationChoice !== '' ?
                      <Card interactive={true}>
                          <div className='row' style={{marginLeft: '5%'}}>
                              <div className='column column-6'>
                                  <div className='sidebar-content'>
                                      {bubbleChartData[this.state.locationChoice]['totalrides'].toLocaleString()}<span
                                      className='sidebar-figure-units'> RIDES</span>
                                  </div>
                              ...
                              <div className='column column-6' style={{marginLeft: '1%'}}>
                                  <div className='sidebar-content'>
                                      {bubbleChartDataOutbound[this.state.locationChoice]['totalrides'].toLocaleString()}<span
                                      className='sidebar-figure-units'> RIDES</span>
                                  </div>
                                  <div className='sidebar-label'>
                                      OUTBOUND TO GREEN
                          ...
                          <div className='row' style={{marginLeft: '5%'}}>
                              <div className='column column-6'>
                                  <div className='sidebar-content'>
                                      {bubbleChartDataYellow[this.state.locationChoice]['totalrides'].toLocaleString()}<span
                                      className='sidebar-figure-units'> RIDES</span>
                                  </div>
                                  <div className='sidebar-label'>
                                      INBOUND FROM YELLOW
                              ...
                              <div className='column column-6' style={{marginLeft: '1%'}}>
                                  <div className='sidebar-content'>
                                      {bubbleChartDataToYellow[this.state.locationChoice]['totalrides'].toLocaleString()}<span
                                      className='sidebar-figure-units'> RIDES</span>
                                  </div>
                                  <div className='sidebar-label'>
                                      OUTBOUND TO YELLOW
                          ...
                          <div className='row' style={{marginLeft: '5%'}}>
                              <div className='column column-6'>
                                  <div className='sidebar-content'>
                                      <span
                                          className='sidebar-figure-dollar'>$</span>{Math.round(bubbleChartData[this.state.locationChoice]['totalfares']).toLocaleString()}
                                  </div>
                                  <div className='sidebar-label'>
                                      TOTAL FARES INBOUND
                                  </div>
                              ...
                              <div className='column column-6' style={{marginLeft: '1%'}}>
                                  <div className='sidebar-content'>
                                      <span
                                          className='sidebar-figure-dollar'>$</span>{Math.round(bubbleChartDataOutbound[this.state.locationChoice]['totalfares']).toLocaleString()}
                                  </div>
                                  <div className='sidebar-label'>
                          ...
                          <div className='row' style={{marginLeft: '5%'}}>
                              <div className='column column-6'>
                                  <div className='sidebar-content'>
                                      {Math.round(bubbleChartData[this.state.locationChoice]['totalmiles']).toLocaleString()}<span
                                      className='sidebar-figure-units'> MILES</span>
                                  </div>
                                  <div className='sidebar-label'>
                              ...
                              <div className='column column-6' style={{marginLeft: '1%'}}>
                                  <div className='sidebar-content'>
                                      {Math.round(bubbleChartDataOutbound[this.state.locationChoice]['totalmiles']).toLocaleString()}<span
                                      className='sidebar-figure-units'> MILES</span>
                                  </div>
                                  <div className='sidebar-label'>
